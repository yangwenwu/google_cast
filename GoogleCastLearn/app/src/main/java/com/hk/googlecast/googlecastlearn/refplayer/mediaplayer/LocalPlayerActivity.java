...
package com.hk.googlecast.googlecastlearn.refplayer.mediaplayer;
...
import com.hk.googlecast.googlecastlearn.R;
import com.hk.googlecast.googlecastlearn.refplayer.browser.VideoProvider;
import com.hk.googlecast.googlecastlearn.refplayer.expandedcontrols.ExpandedControlsActivity;
import com.hk.googlecast.googlecastlearn.refplayer.queue.ui.QueueListViewActivity;
import com.hk.googlecast.googlecastlearn.refplayer.settings.CastPreference;
import com.hk.googlecast.googlecastlearn.refplayer.utils.Utils;
        ...
        switch (state) {
            case PLAYING:
                ...
                mPlayPause.setImageDrawable(
                        getResources().getDrawable(R.mipmap.ic_av_pause_dark));
            ...
            case PAUSED:
                ...
                mPlayPause.setVisibility(View.VISIBLE);
                mPlayPause.setImageDrawable(
                        getResources().getDrawable(R.mipmap.ic_av_play_dark));
                mPlayCircle.setVisibility(isConnected ? View.VISIBLE : View.GONE);
                break;
            case BUFFERING:
