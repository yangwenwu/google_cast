...
package com.hk.googlecast.googlecastlearn.refplayer.queue.ui;
...
import com.hk.googlecast.googlecastlearn.refplayer.queue.QueueDataProvider;
...
public class QueueListAdapter extends RecyclerView.Adapter<QueueListAdapter.QueueItemViewHolder>
    ...
    private static final int PLAY_RESOURCE = R.mipmap.ic_play_arrow_grey600_48dp;
    private static final int PAUSE_RESOURCE = R.mipmap.ic_pause_grey600_48dp;
    private static final int DRAG_HANDLER_DARK_RESOURCE = R.mipmap.ic_drag_updown_grey_24dp;
    private static final int DRAG_HANDLER_LIGHT_RESOURCE = R.mipmap.ic_drag_updown_white_24dp;
